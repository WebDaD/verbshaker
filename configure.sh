...
textValue default.position_vertical "Default position of the Text (vertically, can be top, middle, bottom)"
textValue default.position_horizontal "Default position of the Text (horizontally, can be left, center, right)"
echo "------------------"
...
boolValue changeable.hideNav "Allow Hiding of Navigation"
...
boolValue changeable.textposition "Allow Change of Position of Text"
echo "------------------"
